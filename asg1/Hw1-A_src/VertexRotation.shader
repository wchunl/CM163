    ...
    SubShader
    {
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                float3x3 rotationMatrix_x = getRotationMatrixX(rad);
                float3x3 rotationMatrix_y = getRotationMatrixY(rad);
                float3x3 rotationMatrix_z = getRotationMatrixZ(rad);
                float3x3 rotationMatrix = rotationMatrix_x + rotationMatrix_y + rotationMatrix_z;
